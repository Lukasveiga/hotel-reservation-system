    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, this.base_url + "/admin/chain").permitAll()
                        .requestMatchers(HttpMethod.POST, this.base_url + "/admin/local").hasAuthority("ROLE_chainAdmin")
                        .requestMatchers(this.base_url + "/hotel-admin/**").hasAuthority("ROLE_localAdmin")
